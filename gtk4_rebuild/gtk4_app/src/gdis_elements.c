...
static const gdouble gdis_element_legacy_charges[119] = {
  0.000000,  1.000000,  0.000000,  1.000000,  1.000000,  3.000000,  4.000000,  -3.000000,
  -2.000000,  -1.000000,  0.000000,  1.000000,  2.000000,  3.000000,  4.000000,  5.000000,
  6.000000,  -1.000000,  0.000000,  1.000000,  2.000000,  3.000000,  4.000000,  4.000000,
  3.000000,  2.000000,  3.000000,  2.000000,  2.000000,  2.000000,  2.000000,  3.000000,
  4.000000,  3.000000,  4.000000,  -1.000000,  0.000000,  1.000000,  2.000000,  3.000000,
  4.000000,  4.000000,  4.000000,  7.000000,  4.000000,  3.000000,  4.000000,  2.000000,
  2.000000,  3.000000,  2.000000,  3.000000,  4.000000,  -1.000000,  0.000000,  1.000000,
  2.000000,  3.000000,  3.000000,  3.000000,  3.000000,  3.000000,  3.000000,  3.000000,
  3.000000,  3.000000,  3.000000,  3.000000,  3.000000,  3.000000,  3.000000,  3.000000,
  4.000000,  5.000000,  4.000000,  4.000000,  4.000000,  4.000000,  4.000000,  3.000000,
  2.000000,  3.000000,  2.000000,  3.000000,  6.000000,  7.000000,  0.000000,  1.000000,
  2.000000,  3.000000,  4.000000,  3.000000,  4.000000,  3.000000,  3.000000,  3.000000,
...
gboolean
gdis_element_lookup_legacy_charge(const char *symbol,
                                  gdouble *charge_out)
{
  const GdisElementInfo *element;

  g_return_val_if_fail(charge_out != NULL, FALSE);

  element = gdis_element_lookup(symbol);
  if (!element || element->atomic_number >= G_N_ELEMENTS(gdis_element_legacy_charges))
    {
      *charge_out = 0.0;
      return FALSE;
    }

  *charge_out = gdis_element_legacy_charges[element->atomic_number];
  return TRUE;
}
