...
DEFINE_CLICK_WRAPPER(measure_search_setup)
DEFINE_CLICK_WRAPPER(measure_select_all)
DEFINE_CLICK_WRAPPER(meas_prune_selected)
DEFINE_CLICK_WRAPPER(meas_dump_all)
...
button = gui_icon_button(GTK_STOCK_FIND, "Search ", cb_measure_search_setup, NULL, NULL);
...
gui_button(" Select ", cb_measure_select_all, NULL, hbox, TT);
gui_button(" Delete ", cb_meas_prune_selected, NULL, hbox, TT);
gui_button(" Dump ", cb_meas_dump_all, NULL, hbox, TT);
