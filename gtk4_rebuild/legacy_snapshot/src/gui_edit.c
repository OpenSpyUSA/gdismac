...
#define DEFINE_CLICK_WRAPPER(name)                              \
...
DEFINE_CLICK_WRAPPER(edit_atom_add)
DEFINE_CLICK_WRAPPER(edit_shells_add)
DEFINE_CLICK_WRAPPER(edit_shells_delete)
DEFINE_CLICK_WRAPPER(gui_connect_toggle)
DEFINE_CLICK_WRAPPER(edit_model_create)
DEFINE_CLICK_WRAPPER(edit_make_supercell)
DEFINE_CLICK_WRAPPER(edit_make_p1)
DEFINE_CLICK_WRAPPER(edit_nanotube_new)
DEFINE_CLICK_WRAPPER(construct_transmat)
DEFINE_CLICK_WRAPPER(edit_transform_latmat)
DEFINE_CLICK_WRAPPER(cb_modify_periodicity)
DEFINE_CLICK_WRAPPER(select_flag_ghost)
DEFINE_CLICK_WRAPPER(select_flag_normal)
...
gui_button_x("Add atoms", cb_edit_atom_add, NULL, vbox);
...
gui_button_x("Add shells to selected cores", cb_edit_shells_add, NULL, vbox);
gui_button_x("Remove shells to selected cores", cb_edit_shells_delete, NULL, vbox);
...
gui_button_x("Toggle bonding ", cb_gui_connect_toggle, NULL, vbox);

/* Frame */
vbox = gui_frame_vbox("Structural", FALSE, FALSE, box);

gui_button_x("Make new model", cb_edit_model_create, NULL, vbox);
gui_button_x("Make supercell", cb_edit_make_supercell, NULL, vbox);
gui_button_x("Force structure to P1", cb_edit_make_p1, NULL, vbox);
...
gui_button_x("Create nanotube ", cb_edit_nanotube_new, NULL, vbox);
...
gui_button_x(NULL, cb_construct_transmat, NULL, hbox);
...
gui_button_x("Apply to lattice matrix", cb_edit_transform_latmat, NULL, vbox);
...
gui_button_x(NULL, cb_cb_modify_periodicity, NULL, hbox);
...
gui_button_x("Mark as ghost", cb_select_flag_ghost, NULL, vbox);
gui_button_x("Mark as normal", cb_select_flag_normal, NULL, vbox);
