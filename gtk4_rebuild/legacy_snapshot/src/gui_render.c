...
#define DEFINE_SIGNAL_WRAPPER(name)                             \
static void cb_##name(GtkWidget *widget, gpointer data)         \
{                                                               \
  (void) widget;                                                \
  (void) data;                                                  \
  (void) name();                                                \
...
DEFINE_SIGNAL_WRAPPER(gl_font_dialog)
DEFINE_SIGNAL_WRAPPER(render_refresh)
DEFINE_SIGNAL_WRAPPER(connect_refresh_global)
DEFINE_SIGNAL_WRAPPER(toggle_axes_type)
DEFINE_SIGNAL_WRAPPER(render_mode_polyhedral)
DEFINE_SIGNAL_WRAPPER(render_mode_zone)
DEFINE_SIGNAL_WRAPPER(render_wire_atoms)
DEFINE_SIGNAL_WRAPPER(render_solid_atoms)
DEFINE_SIGNAL_WRAPPER(gui_create_waypoint)
...
gui_button_x("Polyhedral", cb_render_mode_polyhedral, NULL,  vbox);
gui_button_x("Stick", render_mode_set, GINT_TO_POINTER(STICK), vbox);
gui_button_x("Zone based", cb_render_mode_zone, NULL, vbox);
gui_button_x("Wire frame", cb_render_wire_atoms, NULL, vbox);
gui_button_x("Solid", cb_render_solid_atoms, NULL, vbox);
}
...
gui_button_x("Polyhedral", cb_render_mode_polyhedral, NULL,  vbox);
gui_button_x("Stick", render_mode_set, GINT_TO_POINTER(STICK), vbox);
gui_button_x("Zone based (experimental)", cb_render_mode_zone, NULL, vbox);
gui_button_x("Wire frame molecules", cb_render_wire_atoms, NULL, vbox);
gui_button_x("Solid molecules", cb_render_solid_atoms, NULL, vbox);
gui_button_x("Switch axes type", cb_toggle_axes_type, NULL, vbox);

/* extra toggles */
vbox = gui_frame_vbox(NULL, FALSE, FALSE, vbox1);

gui_direct_check("Antialias", &sysenv.render.antialias,
                   cb_render_refresh, NULL, vbox);
...
gui_button_x("Add waypoint ", cb_gui_create_waypoint, NULL, vbox);
...
/* change font options */
gui_button_x("Change graphics font", cb_gl_font_dialog, NULL, vbox);
}
...
gui_auto_check("Show cell", cb_render_refresh, NULL, &model->show_cell, vbox);
gui_auto_check("Show cell images", cb_render_refresh, NULL, &model->show_cell_images, vbox);
gui_auto_check("Show cell lengths", cb_render_refresh, NULL, &model->show_cell_lengths, vbox);
gui_auto_check("Show cores", cb_render_refresh, NULL, &model->show_cores, vbox);
gui_auto_check("Show shells", cb_render_refresh, NULL, &model->show_shells, vbox);
gui_auto_check("Show core-shell links", cb_render_refresh, NULL, &model->show_links, vbox);
gui_auto_check("Show core indices", cb_render_refresh, NULL, &model->show_atom_index, vbox);
gui_auto_check("Show core labels", cb_render_refresh, NULL, &model->show_atom_labels, vbox);
gui_auto_check("Show core types", cb_render_refresh, NULL, &model->show_atom_types, vbox);
gui_auto_check("Show core charges", cb_render_refresh, NULL, &model->show_core_charges, vbox);
gui_auto_check("Show shell charges", cb_render_refresh, NULL, &model->show_shell_charges, vbox);
gui_auto_check("Show atom charges", cb_render_refresh, NULL, &model->show_atom_charges, vbox);

/*VZ*/
gui_auto_check("Show NMR shielding", cb_render_refresh, NULL, &model->show_nmr_shifts, vbox);
gui_auto_check("Show NMR CSA", cb_render_refresh, NULL, &model->show_nmr_csa, vbox);
gui_auto_check("Show NMR EFG", cb_render_refresh, NULL, &model->show_nmr_efg, vbox);

/*
gui_auto_check("Show normal bonds", connect_refresh_global, NULL, &model->build_molecules, vbox);
*/
gui_auto_check("Show hydrogen bonds", cb_connect_refresh_global, NULL, &model->build_hydrogen, vbox);
gui_auto_check("Show zeolite bonds", cb_connect_refresh_global, NULL, &model->build_zeolite, vbox);

gui_auto_check("Show labels on selection ", cb_render_refresh, NULL, &model->show_selection_labels, vbox);

/* next frame */
vbox = gui_frame_vbox(NULL, FALSE, FALSE, vbox2);

gui_auto_check("Show axes", cb_render_refresh, NULL, &model->show_axes, vbox);

gui_direct_check("Show energy", &sysenv.render.show_energy, cb_render_refresh, NULL, vbox);
...
gui_auto_check("Show region 1", cb_render_refresh, NULL, &model->show_region1A, region_render_sensitive_box);

gui_auto_check("Show region 2", cb_render_refresh, NULL, &model->show_region2A, region_render_sensitive_box);

gui_auto_check("Show region 3", cb_render_refresh, NULL, &model->show_region1B, region_render_sensitive_box);

gui_auto_check("Show region 4", cb_render_refresh, NULL, &model->show_region2B, region_render_sensitive_box);
