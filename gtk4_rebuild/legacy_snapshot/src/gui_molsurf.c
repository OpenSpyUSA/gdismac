...
DEFINE_CLICK_WRAPPER(ms_calculate)
DEFINE_CLICK_WRAPPER(ms_delete)
...
gui_stock_button(GTK_STOCK_EXECUTE, cb_ms_calculate, NULL,
                   GTK_DIALOG(window)->action_area);

gui_stock_button(GTK_STOCK_REMOVE, cb_ms_delete, NULL,
                   GTK_DIALOG(window)->action_area);
