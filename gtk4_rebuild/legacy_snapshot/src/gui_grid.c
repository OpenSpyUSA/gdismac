...
DEFINE_CLICK_WRAPPER(gui_job_refresh_all)
DEFINE_CLICK_WRAPPER(gui_job_refresh_selected)
...
/* TODO ... then automate */
gui_button(" Refresh all", cb_gui_job_refresh_all, NULL, hbox, 0);
/* TODO - refresh selected */
gui_button(" Refresh ", cb_gui_job_refresh_selected, NULL, hbox, 0);
