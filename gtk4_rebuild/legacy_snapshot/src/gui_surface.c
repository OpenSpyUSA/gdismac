...
DEFINE_CLICK_WRAPPER(fn_add_plane_with_shift)
DEFINE_CLICK_WRAPPER(fn_add_valid_shifts)
DEFINE_CLICK_WRAPPER(make_morph)
DEFINE_CLICK_WRAPPER(surf_prune_selected)
DEFINE_CLICK_WRAPPER(surf_prune_invalid)
DEFINE_CLICK_WRAPPER(surf_prune_all)
DEFINE_CLICK_WRAPPER(gulp_dialog)
...
gui_button_x("Add the current surface", cb_fn_add_plane_with_shift, NULL, vbox1);
gui_button_x("Add all valid shifts", cb_fn_add_valid_shifts, NULL, vbox1);
...
*/
gui_button_x("Create morphology", cb_make_morph, NULL, vbox1);
...
/* shift operation button row */
  ...
  gui_button("Delete ", cb_surf_prune_selected, data, hbox, TT);
  }
else
  {
  hbox = gtk_hbox_new(TRUE, PANEL_SPACING);
  ...
  gui_button("Calculation setup", cb_gulp_dialog, data, hbox, TT);
/*
  hbox = gtk_hbox_new(TRUE, PANEL_SPACING);
  gtk_box_pack_start(GTK_BOX(vbox), hbox, FALSE, FALSE, 0);
